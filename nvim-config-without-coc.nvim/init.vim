...
nnoremap f :noautocmd execute "lvimgrep /".expand("<cword>")."/gj **/*" <Bar> lw <CR>
...
let g:FFSRoot=getcwd()

" Show Files searched fuzzily
function! FuzzyFileSearch(substr)
    call feedkeys(":Redir !find ".g:FFSRoot." -path '*".a:substr."*'\<CR>" ,'n')
    call feedkeys("/".a:substr."\<CR>")
endfunction
